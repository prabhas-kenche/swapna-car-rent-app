...
import Car360Viewer from '../360degree'
...
const Home = () => {
    ...
    <div className="row align-items-center">
        ...
        <div className="col-12 col-md-7 text-center">
            <img src="https://autozone-theme.com/lux/wp-content/uploads/2024/01/martin-katler-y3neNkE6efI-unsplash-min.jpg" alt="car-image" className="img-fluid" />
        </div>
    </div>
            </div>
    ...
    <div className="container">
        <div className="row align-items-center">
            <div className="col-12 col-md-4 text-center mb-4 mb-md-0">
                <img src="https://autozone-theme.com/lux/wp-content/uploads/2024/01/chuttersnap-gts_Eh4g1lk-unsplash.jpg" className="img-fluid" alt="stat-image" />
            </div>
    ...
    <div className="container">
        <div className="row align-items-center mb-5">
            ...
            <div className="col-12 col-md-8">
                <img src="https://autozone-theme.com/lux/wp-content/uploads/2024/01/marc-olivier-jodoin-NqOInJ-ttqM-unsplash.jpg" className="img-fluid" alt="light-spark-image" />
            </div>
        </div>
        <div className="row align-items-center mb-5">
            ...
            <div className="col-12 col-md-8 order-md-1">
                <img src="https://autozone-theme.com/lux/wp-content/uploads/2024/01/andrey-zvyagintsev-DTQxGDTeyj0-unsplash.jpg" className="img-fluid" alt="light-spark-image" />
            </div>
        </div>
        <div className="row align-items-center mb-5 quote-image">
            <img src="https://res.cloudinary.com/dzptijryk/image/upload/v1726259183/Screenshot_14-9-2024_15530_autozone-theme.com_efef75.jpg" alt="car-quote" className="quote-img" />
        </div>
    </div>
            </div>
    ...
    <div className="image-container">
        <img className="responsive-image" src="https://img.freepik.com/premium-photo/cheerful-indian-man-driving-new-car-calling-via-phone_116547-81161.jpg" alt="Cheerful Indian man driving a new car" />
    ...
    <div className="container">
        <div className="grid-container">
            <div className="grid-item">
                <h3>YOUR PATH TO LIGHT YOUR WAY?</h3>
                <p>
                    Fully customizable and every page can be fully customized so you
                    will not have any problems using your own logo, texts, or other
                    elements to design it the way you want.
                </p>
            </div>
